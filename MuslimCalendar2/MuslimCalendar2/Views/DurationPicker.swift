...
struct DurationPicker: View {
    ...
    let dateRange: ClosedRange<Date> = {
        ...
        let startComponents = DateComponents(timeZone: TimeZone.gmt, year: 1970, hour: 0, minute: 1)
        let endComponents = DateComponents(timeZone: TimeZone.gmt, year: 1970, hour: 23, minute: 59)
